...
from simpleflow.engines import compiler as co
from simpleflow.engines import deciders
from simpleflow.engines import traversal
...
class Selector(object):
    ...
    def _get_maybe_ready_for_execute(self, atom):
        ...
        decider_fetcher = lambda: \
            deciders.IgnoreDecider(atom, self._runtime.fetch_edge_deciders(atom))
