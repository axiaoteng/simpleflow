...
from simpleflow import deciders as de
from simpleflow import states as st
from simpleflow.utils import misc
from simpleflow.flow import LINK_DECIDER  # noqa
from simpleflow.flow import LINK_DECIDER_DEPTH  # noqa
from simpleflow.engines.actions import retry as ra
from simpleflow.engines.actions import task as ta
from simpleflow.engines import builder as bu
from simpleflow.engines import compiler as com
from simpleflow.engines import completer as co
from simpleflow.engines import scheduler as sched
from simpleflow.engines import scopes as sc
from simpleflow.engines import selector as se
from simpleflow.engines import traversal as tr
...
class Runtime(object):
    ...
    @misc.cachedproperty
    def builder(self):
        return bu.MachineBuilder(self, futurist.wait_for_any)
